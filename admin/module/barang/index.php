        ...
        <button type="button" class="btn btn-primary btn-md mr-2 my-2" data-toggle="modal" data-target="#myModal">
            <i class="fa fa-plus"></i> Insert Data</button>
        <a href="index.php?page=barang&stok=yes" class="btn btn-warning btn-md mr-2 my-2">
            <i class="fa fa-list"></i> Sortir Stok Kurang</a>
        <a href="index.php?page=barang" class="btn btn-success btn-md my-1">
                            ...
                            <td>
                                ...
                                <form method="POST" action="fungsi/edit/edit.php?stok=edit">
                                    ...
                                    <a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id_barang'];?>"
                                        ...
                                        <button class="btn btn-danger btn-sm mt-1">Hapus</button></a>
                                </form>
                                <?php }else{?>
                                ...
                                <a href="index.php?page=barang/edit&barang=<?php echo $isi['id_barang'];?>"><button
                                        class="btn btn-warning btn-xs mt-1">Edit</button></a>
                                <a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id_barang'];?>"
                                    onclick="javascript:return confirm('Hapus Data barang ?');"><button
                                        class="btn btn-danger btn-xs mt-1">Hapus</button></a>
                                <?php }?>
                        </tr>
                        <?php 
							$no++; 
